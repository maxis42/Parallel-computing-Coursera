...
the standalone Inspector XE GUI.
...
Click the blue arrow on the Intel Inspector XE toolbar to configure a new analysis. Choose Detect Deadlocks and Data Races 
...
Click the blue arrow on the Intel Inspector XE toolbar to configure a new analysis. Choose Detect Memory Problems and press 
...
You have successfully performed threading and memory analysis using the Intel Inspector XE. 
